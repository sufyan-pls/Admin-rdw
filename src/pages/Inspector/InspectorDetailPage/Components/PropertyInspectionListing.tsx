...
const PropertyInspectionListing = ({ data, loading }: ApprovedListingProps) => {
    ...
    const columns = [
        ...
        { header: "Listed For", accessorKey: "listedFor", enableColumnFilter: false },
        {
            ...
            accessorKey: 'listingStatus', // yahan data me 'listingStatus' hai
...
export default PropertyInspectionListing;
