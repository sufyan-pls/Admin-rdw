...
const InspectorEditModal = ({ isOpen, toggle, user }: any) => {
    return (
        <Modal isOpen={isOpen} toggle={toggle} size="lg" centered backdrop="static" className="edit-user-modal">
            <ModalHeader toggle={toggle} className="border-bottom-0 pb-0">Edit Inspector</ModalHeader>
            <ModalBody className="pt-0 pb-2 px-4">
                ...
                {/* User Status */}
                <div className="fw-semibold mt-4 mb-2" style={{ fontSize: 17 }}>Inspector Status</div>
...
export default InspectorEditModal; 