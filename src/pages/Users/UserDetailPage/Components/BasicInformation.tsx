        ...
        <Card className="mb-3 " style={{ maxWidth: '100%', boxSizing: 'border-box' }}>
            <CardBody className="pb-2">
                ...
                <div className="align-items-center justify-content-start" style={{ gap: 40, display: 'flex', flexDirection: 'row' }}>
                    <div className="d-flex flex-row justify-content-between" style={{ display: 'flex', flexDirection: 'row', alignItems: 'start', justifyContent: 'start', gap: 20 }}>
                        ...
                        <div className="d-flex flex-row mt-3" style={{ gap: 20 }}>
                            ...
                            <div >
                                <span className="fw-semibold" style={{ fontSize: 16 }}>User ID</span>
                                <p className="text-muted" style={{ fontSize: 15 }}>{info.builderId}</p>
                            </div>
                        </div>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center, space-around', }}>
            ...
            <UserEditModal isOpen={editModalOpen} toggle={() => setEditModalOpen(false)} user={selectedUser} />
        </Card>
    );
};
