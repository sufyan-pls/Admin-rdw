...
import UpdatesRequiredModal from '../Modals/UpdatesRequiredModal';
import TransactionDetailsModal from '../Modals/TransactionDetailsModal';
import AssignInspectorModal from '../Modals/AssignInspectorModal';

const CompanyInspection = () => {
    ...
    return (
        <Card className="mb-3">
            <CardHeader onClick={toggle} style={{ cursor: 'pointer' }} className="d-flex justify-content-between align-items-center">
                <h6 className="mb-0">Company Inspection</h6>
                <div className="d-flex align-items-center">
                    <span className="badge bg-light text-dark me-2">Pending</span>
                ...
                <CardBody>
                    <Row className="mb-2">
                        ...
                        <Col xs={8} className="text-end">
                            <span className="badge bg-light text-dark">{inspectionData.status}</span>
                        </Col>
                    </Row>
                    <Row className="mb-2">
                        <Col xs={4}>Date</Col>
                    ...
                    <Row className="mb-2 text-end">
                        <a href="#" className="ms-2 text-primary">View Details</a>
                    </Row>
                    {/* Inspector Box */}
                    <div className="mb-3">
                        <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        { callToAction && <div className="d-flex align-items-center mb-3">
                        ...
                        {callToAction &&<h6 className="mb-3">Updated Report</h6>}
            ...
            <TransactionDetailsModal isOpen={transactionModalOpen} toggle={() => setTransactionModalOpen(!transactionModalOpen)} />
            <UpdatesRequiredModal isOpen={updatesModalOpen} toggle={() => setUpdatesModalOpen(!updatesModalOpen)} setCallToAction={setCallToAction} />
        </Card>
    );
};
