...
import registerBanner from '../../assets/images/svg/backgrounds/registerBanner.svg';
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    ...
                                    <p className="mb-0 text-muted">&copy; {new Date().getFullYear()} RealWealtdy. All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                    </div>
