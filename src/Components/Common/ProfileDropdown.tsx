...
const ProfileDropdown = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <DropdownToggle tag="button" type="button" className="btn profile-dropdown-toggle w-100">
          <span className="d-flex align-items-center justify-content-between w-100">
            <span className="d-flex align-items-center">
              ...
              <span className="d-flex flex-column ms-2">
                ...
                <span className="fs-13 text-muted user-name-sub-text">
                  Admin
                </span>
              </span>
            </span>
        ...
        <DropdownMenu className="dropdown-menu-end">
          ...
          <DropdownItem className="p-0">
            <Link to="/logout" className="dropdown-item">
              ...
              <span className="align-middle text-danger" data-key="t-logout">
                Logout
              </span>
            </Link>
          </DropdownItem>
